...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="styles/style.css">        <title>Document</title>
    </head>
    <b ody>
        <div class="container-sp">
            ...
            <main>  
                <div class="container-fluid mt-cm">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="text-center">Aggiorna password</h2>
                                    ...
                                    <div class="p-5">
                                        <form action="controller/controllerPassword.php" method="POST">
                                            ...
                                            <div>                                        
                                                ...
                                                <div class="pass">
                                                    <input class="w-100" type="password" name="password" placeholder="Scrivila qui" required><i class="fa-solid fa-eye text-primary"></i>
                                                    <p class="text-danger"><?php echo $messaggioErrore; ?></p>
                                                </div>
                                            </div>
                                            <button class="w-100 fw-bold text-center" type="submit">AGGIORNA</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
